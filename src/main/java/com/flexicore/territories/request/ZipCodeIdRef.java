...
public class ZipCodeIdRef {
    ...
    public ZipCodeIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public ZipCodeIdRef(String id) {
        this.id = id;
    }
    ...
    public ZipCodeIdRef setFilterId(String filterId) {
    ...
    public ZipCodeIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
