...
public class CityIdRef {
    ...
    public CityIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public CityIdRef(String id) {
        this.id = id;
    }
    ...
    public CityIdRef setFilterId(String filterId) {
    ...
    public CityIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
