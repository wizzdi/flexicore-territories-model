...
@Entity
public class NeighbourhoodIdRef {
    ...
    public NeighbourhoodIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public NeighbourhoodIdRef(String id) {
        this.id = id;
    }
    ...
    public NeighbourhoodIdRef setFilterId(String filterId) {
    ...
    public NeighbourhoodIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
