...
@Entity
public class NeighbourhoodExternalIdRef {
    ...
    public NeighbourhoodExternalIdRef() {
    }
    ...
    public NeighbourhoodExternalIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public NeighbourhoodExternalIdRef(String id) {
        this.id = id;
    }
    ...
    public NeighbourhoodExternalIdRef setFilterId(String filterId) {
    ...
    public NeighbourhoodExternalIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
