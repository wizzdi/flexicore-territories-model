...
public class CountryIdRef {
    ...
    public CountryIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public CountryIdRef(String id) {
        this.id = id;
    }
    ...
    public CountryIdRef setFilterId(String filterId) {
    ...
    public CountryIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
