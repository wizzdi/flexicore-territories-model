...
@Entity
public class AddressExternalIdRef {
    ...
    public AddressExternalIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public AddressExternalIdRef(String id) {
        this.id = id;
    }
    ...
    public AddressExternalIdRef setFilterId(String filterId) {
    ...
    public AddressExternalIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
