...
public class FloorIdRef {
    ...
    public FloorIdRef setId(int id) {
        this.id = id;
        return this;
    }

    public FloorIdRef(int id) {
        this.id = id;
    }
    ...
    public FloorIdRef setFilterId(String filterId) {
    ...
    public FloorIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
